...
function closeNav(){document.querySelector(".nav").style.width="0"}$(".header__bar").click(function(){document.querySelector(".nav").style.width="100%"}),window.addEventListener("scroll",function(){document.querySelector(".header").classList.toggle("sticky",0<window.scrollY)});let loadMoreBtn=document.querySelector(".btn__loadmore"),currentItem=3;loadMoreBtn.onclick=()=>{let e=[...document.querySelectorAll(".portfolio__card")];for(var t=currentItem;t<currentItem+3;t++)e[t].style.display="inline-block";currentItem+=3,currentItem>=e.length&&(loadMoreBtn.style.display="none")};